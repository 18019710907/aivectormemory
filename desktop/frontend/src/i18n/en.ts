export default {
  ...
  searchIssueInRange: 'Search issues in date range...',
  ...
  total: 'Total',
  items: 'items',
  issuesTotalAll: 'Total',
  issuesTotalToday: 'Today',
  issuesCurrentQuery: 'In range',
  ...
  auth: {
    ...
    usernameTaken: 'This username is already taken. Please choose another or log in.',
